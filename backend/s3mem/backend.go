...
func (db *Backend) PutObject(bucketName, objectName string, meta map[string]string, input io.Reader, size int64, storageClass string) (result gofakes3.PutObjectResult, err error) {
